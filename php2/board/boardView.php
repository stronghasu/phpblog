...
<?php
    ...
    $sql = "SELECT b.boardTitle, m.youName, b.regTime, b.boardView, b.boardContents FROM harryBoard b JOIN harryMember m ON(m.memberID = b.memberID) WHERE b.boardID = {$boardID}";
    ...
    // 조회수증가
    $up_view = "UPDATE harryBoard SET boardView = boardView+1 WHERE boardID = {$boardID}";
    $result = $connect -> query($up_view);
?>
                            </tbody>
                        </table>
                    </div>
