...
<body>
    ...
    <main id="contents">
        ...
        <section id="board-type" class="section center mb100">
            <div class="container">
                <h3 class="section__title">나의 게시판</h3>
                <p class="section__desc">블로그주인의 게시판입니다. 즐겁게 둘러보세요</p>
...
<?php
    ...
    $sql = "SELECT b.boardID, b.boardTitle, m.youName, b.regTime, b.boardView FROM harryBoard b JOIN harryMember m ON(b.memberID = m.memberID) ORDER BY boardID DESC LIMIT {$pageLimit}, {$pageView}";
...
?>
                    ...
                    <div class="board__pages">
                       <ul>
                            <?php
                            $sql = "SELECT count(boardID) FROM harryBoard";
                            $result = $connect -> query($sql);
                            ...
                            //  echo $boardCount;
                            //  데이터를 result써서 fetch_array(MYSQLI_ASSOC);에 넣고 count만 가져와서 boardCount 를 대입시켜줌
